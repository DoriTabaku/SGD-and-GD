%function [w,beta]=gradient_method_backtracking(C,w0,beta0,t,lambda,alpha,gama)
%C....vectors x(i)..represent each column of C;
%alpha......backtracking coefficent
%gama.......backtracking coefficent
tic;
